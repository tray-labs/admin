<template>
    <div>
        ...
        <div class="animated fade-in-right">
            <div class="row">
                <div class="ls-box">
                    <div class="ls-float-right">
                        <a href="" class="ls-btn-primary ls-clearfix" target="_blank">Acessar o Painel</a>
                        <div data-ls-module="dropdown" class="ls-dropdown ls-clearfix">
                            <a href="#" class="ls-btn ls-btn-lg ls-v-align-middle"> </a>
                            <ul class="ls-dropdown-nav">
                                ...
                                <li>
                                    <a href="#" data-ls-module="modal" data-target="#editPassword">Alterar senha</a>
                                </li>
                                <li>
                                    <a href="#">Desativar</a>
                                </li>
            ...
            <div class="row ls-md-space ls-no-padding-bottom ls-no-padding-left ls-no-padding-right">
                ...
                <div class="ls-box-filter">
                    <form action="" class="ls-form ls-form-inline">
                        ...
                        <div class="ls-actions-btn">
                            <button type="button" class="ls-btn ls-v-align-middle">Filtrar</button>
                        </div>
                    </form>
                </div>
            ...
            <form action="" class="ls-form">
                <div class="ls-modal-small">
                    ...
                    <div class="ls-modal-footer">
                        <button type="submit" class="ls-btn-primary">Salvar</button>
                        <button data-dismiss="modal" class="ls-btn ls-float-right">Cancelar</button>
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    import BarExample2 from '../charts/BarExample2.vue'
    ...
    export default {
        ...
        created() {
            this.$route.meta.label = 'Fulano de Tal';
        }
    }
</script>
